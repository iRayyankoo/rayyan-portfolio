...
const translations = {
    ar: {
        ...
        btn_bi_dossier: "ملف إثبات الأهلية - ذكاء الأعمال (PDF)",
        scroll_label: "SCROLL",
    ...
    en: {
        ...
        btn_bi_dossier: "BI Freelance Dossier (PDF)",
        scroll_label: "SCROLL",
        ...
        cs_naht_web_p3: "Every walkthrough reservation and prospectus request is routed automatically via secure cloud Webhook pipelines into the <strong>Naht CRM Engine</strong> and <em>WhatsApp Business API</em>, dispatching instant notifications to sales consultants and qualifying buyer intent within 8 minutes.",
        ...
        cs_sportx_p2: "We built a real-time reservation engine powered by in-memory <code>Redis</code> locks and <code>WebSockets</code> to lock booking slots instantly and permanently prevent race conditions. An automated <em>Tournament Engine</em> computes group stages, knockout trees, goal differentials, and tie-breakers autonomously with zero human intervention.",
        cs_sportx_h3: "03. Fan Experience & Contactless Access",
        cs_sportx_p3: "The platform generates encrypted <em>Dynamic QR</em> for turnstile validation within seconds, integrated with Saudi national payment rails (Mada, Visa, and Apple Pay). Automated digital wallet integration (Apple & Google Wallet) manages instantaneous refunds upon cancellation, eliminating cashier friction.",
