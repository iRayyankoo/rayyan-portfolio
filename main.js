...
const translations = {
    ar: {
        ...
        exp_1: "بناء الهوية وتطوير العلامات التجارية (Corporate Branding)",
        exp_2: "إدارة الحملات التسويقية الرقمية",
        exp_3: "تطوير المواقع والأنظمة الداخلية",
        exp_4: "تصميم المحتوى الإبداعي",
        exp_5: "التسويق للفعاليات والمؤتمرات",
        exp_6: "تحسين محركات البحث (SEO)",
        exp_7: "إعلانات جوجل (Google Ads)",
        exp_8: "إعلانات ميتا (Meta Ads)",
        exp_9: "استهداف الجمهور (Audience Targeting)",
        exp_10: "تحسين معدل التحويل (Conversion Optimization)",
        exp_11: "تحليلات التسويق (Marketing Analytics)",
    ...
    en: {
        ...
        exp_1: "Corporate Branding & Identity Development",
        exp_2: "Digital Marketing Campaigns",
        exp_3: "Website & Internal Systems Development",
        exp_4: "Creative Content Design",
        exp_5: "Event & Conference Marketing",
        exp_6: "Search Engine Optimization (SEO)",
        exp_7: "Google Ads",
        exp_8: "Meta Ads",
...
function setupLightbox() {
    ...
    const galleryImages = document.querySelectorAll('.panel-img-wrapper img');
