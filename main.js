...
const translations = {
    ar: {
        ...
        p6_desc: "تطوير شامل للهوية البصرية الفاخرة وهندسة التغليف وتجربة فتح العلبة (Unboxing) لعلامة Ri88 في قطاع المشروبات المختصة، محققة انتشاراً عضوياً واسعاً.",
        ...
        cs_ri88_title: "الهوية التجارية وتجربة Ri88",
        ...
        cs_ri88_h1: "01. سياق التحدي وتنافسية قطاع الأغذية الفاخرة",
        cs_ri88_p1: "يعد قطاع المشروبات والمقاهي المختصة في الرياض من أكثر الأسواق تنافسية في المنطقة. التميز لم يعد يتوقف عند جودة المشروب فحسب، بل يتطلب عالماً بصرياً متكاملاً وتجربة تغليف استثنائية تحفز العميل على الارتباط العاطفي ومشاركة التجربة عفوياً على وسائل التواصل.",
        cs_ri88_h2: "02. هندسة الهوية واللغة البصرية المترفة",
        cs_ri88_p2: "تم ابتكار شعار هندسي حديث يجسد التوازن والأصالة، مدعوماً بلوحة ألوان مستوحاة من درجات البن والتحميص الطبيعي. طُورت أنماط بصرية تجريدية <code>Brand Patterns</code> ونظام تيبوغرافي منسجم يعكس الفخامة الهادئة عبر لوحات المتجر وقوائم الطلب الإلكترونية.",
        cs_ri88_h3: "03. هندسة التغليف وطقوس الفتح (Unboxing)",
        cs_ri88_p3: "هندست عبوات البن ذات صمام التفريغ، وصناديق الهدايا الفاخرة المطعمة بختم البرونز الحراري <code>Hot Foil Stamping</code>، وأكواب تقديم ذات ملمس محكم وخامات صديقة للبيئة. صُممت رحلة فتح المنتج <code>Unboxing Choreography</code> لتمنح العميل إحساساً بالتميز وتقدير التفاصيل الدقيقة.",
        cs_ri88_h4: "04. الأثر التجاري والانتشار العضوي",
        cs_ri88_p4: "رسخ التموضع البصري علامة Ri88 كخيار مفضل بين رواد المقاهي الفاخرة، محققاً مبيعات قوية وانتشاراً واسعاً دون الحاجة لميزانيات تسويق مدفوعة ضخمة.",
        cs_ri88_m1_val: "+45%",
        cs_ri88_m1_lbl: "ارتفاع معدل إعادة الشراء والولاء للعلامة",
        cs_ri88_m2_val: "+2,500",
        cs_ri88_m2_lbl: "محتوى عفوي ومشارك (UGC) في شهر الإطلاق",
        cs_ri88_m3_val: "100%",
        cs_ri88_m3_lbl: "اتساق معايير الطباعة والتغليف عبر خطوط الإنتاج",
        cs_ri88_h5: "05. آفاق التوسع والنمو التجاري",
        cs_ri88_p5: "يشمل المخطط التوسعي للعلامة تصميم معايير الفرانشايز للتوسع في مدن المملكة، وإطلاق خط منتجات معلبة جاهزة للشرب (RTD) بنفس معايير الفخامة.",
    ...
    en: {
        ...
        p6_desc: "Bespoke luxury brand identity, structural packaging engineering, and sensory unboxing choreography in the specialty F&B sector driving viral organic adoption.",
        status_brand: "Brand Experience",
        ...
        cs_ri88_title: "Ri88 Commercial Identity & Experience",
        ...
        cs_ri88_h1: "01. Competitive Landscape in Specialty F&B",
        cs_ri88_p1: "Riyadh's specialty beverage market is among the most saturated in the MENA region. Achieving distinction requires more than exceptional beverage craft; it demands an iconic visual world, bespoke structural packaging, and an immersive consumer unboxing ritual that sparks organic social media advocacy.",
        cs_ri88_h2: "02. Visual Identity Architecture & Spatial Design",
        cs_ri88_p2: "We crafted a geometric monogram uniting modern minimalism with heritage craft, anchored by warm earthen tones reflecting bean roasting stages. Custom abstract <code>Brand Patterns</code> and refined typographic hierarchies were engineered to convey understated luxury across store signage and digital menus.",
        cs_ri88_h3: "03. Structural Packaging & Sensory Unboxing",
        cs_ri88_p3: "Packaging was engineered for sensory tactile impact: degassing-valve bean pouches, rigid gift boxes finished with hot bronze foil stamping <code>Hot Foil Stamping</code>, and eco-friendly cups. The <code>Unboxing Choreography</code> was choreographed to deliver delight and share-worthy moments.",
        cs_ri88_h4: "04. Commercial Impact & Organic Virality",
        cs_ri88_p4: "The elevated brand positioning established Ri88 as an aspirational lifestyle brand, commanding premium pricing and generating widespread customer loyalty without large paid ad budgets.",
        cs_ri88_m1_val: "+45%",
        cs_ri88_m1_lbl: "Customer Retention & Repeat Purchase Rate",
        cs_ri88_m2_val: "+2,500",
        cs_ri88_m2_lbl: "Organic User-Generated Videos (UGC)",
        cs_ri88_m3_val: "100%",
        cs_ri88_m3_lbl: "Production & Dieline Quality Parity",
        cs_ri88_h5: "05. Retail Scalability & Franchise Expansion",
        cs_ri88_p5: "The expansion roadmap includes modular retail franchise manuals, ready-to-drink (RTD) packaging line extensions, and branded e-commerce subscription offerings.",
